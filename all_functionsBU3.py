    ...
    for y in range(gridnumy):
        for x in range(gridnumx):
            if mask2D[y,x]:
                ...
                #
                # if peaktest(index,pos_Y_from_fft[:,y,x]) == False:
                #     mask2D[y, x] = False
                #     bestIDX[y, x] = 0
                #     continue
                ...
                # if flag2 == True:
                #     if peaktest( int(secondHarmonicIDX) ,pos_Y_from_fft[:,y,x]) == False:
                #         mask2D[y, x] = False
                #         bestIDX[y, x] = 0
                #         continue
                ...
                # if flag3 == True:
                #     if peaktest(int(thirdHarmonicIDX),pos_Y_from_fft[:,y,x]) == False:
                #         mask2D[y, x] = False
                #         bestIDX[y, x] = 0
                #         continue
                ...
                #     continue
                # if peaktest(int(secondHarmonicIDX),pos_Y_from_fft[:,y,x]) == False\
                #     and peaktest(int(secondHarmonicIDX-1),pos_Y_from_fft[:,y,x]) == False\
                #     and peaktest(int(secondHarmonicIDX+1),pos_Y_from_fft[:,y,x]) == False:
                #     mask2D[y, x] = False
                #     bestIDX[y, x] = 0
                #     continue
                # if peaktest(int(thirdHarmonicIDX),pos_Y_from_fft[:,y,x]) == False\
                #     and peaktest(int(thirdHarmonicIDX-1),pos_Y_from_fft[:,y,x]) == False\
                #     and peaktest(int(thirdHarmonicIDX-2),pos_Y_from_fft[:,y,x]) == False\
                #     and peaktest(int(thirdHarmonicIDX+1),pos_Y_from_fft[:,y,x]) == False\
                #     and peaktest(int(thirdHarmonicIDX+2),pos_Y_from_fft[:,y,x]) == False:
                #     mask2D[y, x] = False
                #     bestIDX[y, x] = 0
...
def test2(bestStr,maskNfreqID_infoMat,df): # require relative strong strength
    ...
    # print("thrshold idx: ",idx4thr," thr4str: ",absStr0)
    ...
    # plt.plot(idx4thr, absStr0, 'x',color = "red",label = "thrshold Point")
...
#vis and save threshold0
    ...
    plt.savefig(path_prefix + "freqmap.png")
    plt.show()
    ...
    bestStr_test2 = np.where(bestStr/maxStr>absStr0,bestStr/maxStr,0) if maxStr!=0 else bestStr
    ...
    plt.savefig(path_prefix + "magmap.png")
    plt.show()


    # bestStr_test2 = np.where(bestStr/maxStr>absStr0,255,0)if maxStr!=0 else bestStr
    img2 = plt.imshow(maskNfreqID_infoMat[0], cmap="gray")
    # plt.colorbar(img2)
    plt.xticks([])
    plt.yticks([])
    plt.title("\"periodicness\" magnitude distribution of mask with threshold0 ")
    plt.savefig(path_prefix + "magmask0.png")
    plt.show()


    # bestStr_test2 = np.where(bestStr/maxStr>absStr25,255,0)if maxStr!=0 else bestStr
    maskNfreqID_infoMat[2] = np.where(bestStr/maxStr>absStr25,True,False).astype(np.uint32)if maxStr!=0 else False
    img2 = plt.imshow(maskNfreqID_infoMat[2], cmap="gray")
    # plt.colorbar(img2)
    plt.xticks([])
    plt.yticks([])
    plt.title("\"periodicness\" magnitude distribution of mask with threshold25 ")
    plt.savefig(path_prefix + "magmask25.png")
    plt.show()



#vis and save threshold75

    # bestStr_test2 = np.where(bestStr/maxStr>absStr50,255,0)if maxStr!=0 else bestStr
    maskNfreqID_infoMat[3] = np.where(bestStr / maxStr > absStr50, True, False).astype(np.uint32)if maxStr!=0 else False
    img2 = plt.imshow(maskNfreqID_infoMat[3], cmap="gray")
    # plt.colorbar(img2)
    plt.xticks([])
    plt.yticks([])
    plt.title("\"periodicness\" magnitude distribution of mask with threshold50")
    plt.savefig(path_prefix + "magmask50.png")
    plt.show()


    # bestStr_test2 = np.where(bestStr/maxStr>absStr75,bestStr/maxStr,0)if maxStr!=0 else bestStr
    maskNfreqID_infoMat[4] = np.where(bestStr / maxStr > absStr75, True, False).astype(np.uint32)if maxStr!=0 else False
    img2 = plt.imshow(maskNfreqID_infoMat[4],cmap="gray")
    # plt.colorbar(img2)
    plt.xticks([])
    plt.yticks([])
    plt.title("\"periodicness\" magnitude distribution of mask with threshold75")
    plt.savefig(path_prefix + "magmask75.png")
    plt.show()
...
gridnumx = 512#32#128#512#  32#128#512#32#128#  512#32#32#128#512#32#128#512 # 32#128#512#128#32#512#32#512#32#512#32#512#32#64#512#64#512#32#64#512#256#64#512#256#128#64#32#512#45#360#512# 128#512#32#128#512#360#  512#128#32#128#512#32#128#512# 32#128#512#128#512#32#512#32#512#32# 256#512#32#64#  128#32#64#128#256#512#32#64#128#256#512#45#90#180#360#180#360#512#854#720#360#854#360#180#90#360#90#180#360#720#180#72#36#36#18#360#180#18#36#72
gridnumy = 384#24#96#384#24#96# 384#24#96#384#24#24#96#384#24#96#384#24#96#384 #96#24#384#24#384#24#384#24#384#24#48#384#48#384#24#48#384#192#48# 384#192#96#48#24#36#384#36#288#384#96#384# 24#96#384#288# 384#96#96#384# 24#96#384#24#96#384#96#384#24#384#2
videoname = "3"#"11"#"11"#"h3"#"3"#"cardNresp1"#"card1"#"WinB25"#"resp3"#"card1"# \"+videoname+"#BINW25  WINB127 WINB25
givenfreq = 1.3#0.95#1.25#1.3#1.3#1.3#0.8#1.25#1.3#1.5#1.25#0.8#1.25#0.8#1#0.8#1.5#2.3# 0.8#0.35#1.5   # edit it to 1.1  the result is not good as expected!
...
#
#
# extensionDir = "D:\Study\Datasets\AEXTENSION\Cho80_extension\static_cam\static_scene\\"
# videoname = "5"#"11"#"11"#"h3"#"3"#"cardNresp1"#"card1"#"WinB25"#"resp3"#"card1"# \"+videoname+"#BINW25  WINB127 WINB25
# givenfreq = 2#0.95#1.25#1.3#1.3#1.3#0.8#1.25#1.3#1.5#1.25#0.8#1.25#0.8#1#0.8#1.5#2.3# 0.8#0.35#1.5   # edit it to 1.1  the result is not good as expected!
