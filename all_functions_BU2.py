...
#vis and save threshold0
    ...
    bestStr_test2 = np.where(bestStr/maxStr>absStr0,bestStr/maxStr,0)
    ...
    bestStr_test2 = np.where(bestStr/maxStr>absStr0,bestStr/maxStr,0)
    img2 = plt.imshow(maskNfreqID_infoMat[0], cmap='hot', interpolation='nearest')
    plt.colorbar(img2)
    plt.title("\"periodicness\" magnitude distribution of final binary mask ")
    plt.savefig(path_prefix + "magmapF0.png")
    plt.show()


    bestStr_test2 = np.where(bestStr/maxStr>absStr25,bestStr/maxStr,0)
    maskNfreqID_infoMat[2] = np.where(bestStr/maxStr>absStr25,True,False).astype(np.uint32)
    img2 = plt.imshow(maskNfreqID_infoMat[2], cmap='hot', interpolation='nearest')
    plt.colorbar(img2)
    plt.title("\"periodicness\" magnitude distribution of final binary mask ")
    plt.savefig(path_prefix + "magmapF25.png")
    plt.show()
...
#vis and save threshold75
    ...
    bestStr_test2 = np.where(bestStr/maxStr>absStr50,bestStr/maxStr,0)
    maskNfreqID_infoMat[3] = np.where(bestStr / maxStr > absStr50, True, False).astype(np.uint32)
    img2 = plt.imshow(maskNfreqID_infoMat[3], cmap='hot', interpolation='nearest')
    plt.colorbar(img2)
    plt.title("\"periodicness\" magnitude distribution of final binary mask ")
    plt.savefig(path_prefix + "magmapF50.png")
    plt.show()

    bestStr_test2 = np.where(bestStr/maxStr>absStr75,bestStr/maxStr,0)
    maskNfreqID_infoMat[4] = np.where(bestStr / maxStr > absStr75, True, False).astype(np.uint32)
    img2 = plt.imshow(maskNfreqID_infoMat[4], cmap='hot', interpolation='nearest')
    plt.colorbar(img2)
    plt.title("\"periodicness\" magnitude distribution of final binary mask ")
    plt.savefig(path_prefix + "magmapF75.png")
    plt.show()
...
gridnumx =       32#128#512#128#32#512#32#512#32#512#32#512#32#64#512#64#512#32#64#512#256#64#512#256#128#64#32#512#45#360#512# 128#512#32#128#512#360#  512#128#32#128#512#32#128#512# 32#128#512#128#512#32#512#32#512#32# 256#512#32#64#  128#32#64#128#256#512#32#64#128#256#512#45#90#180#360#180#360#512#854#720#360#854#360#180#90#360#90#180#360#720#180#72#36#36#18#360#180#18#36#72
gridnumy =     24#96#384 #96#24#384#24#384#24#384#24#384#24#48#384#48#384#24#48#384#192#48# 384#192#96#48#24#36#384#36#288#384#96#384# 24#96#384#288# 384#96#96#384# 24#96#384#24#96#384#96#384#24#384#2
videoname = "6"#"11"#"11"#"h3"#"3"#"cardNresp1"#"card1"#"WinB25"#"resp3"#"card1"# \"+videoname+"#BINW25  WINB127 WINB25
givenfreq =0.85#0.95#1.25#1.3#1.3#1.3#0.8#1.25#1.3#1.5#1.25#0.8#1.25#0.8#1#0.8#1.5#2.3# 0.8#0.35#1.5   # edit it to 1.1  the result is not good as expected!
...
gt_img_path = meansigarrayDIR+"truth.png"
